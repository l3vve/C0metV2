...
elseif placeid == 6872265039 then
    if betterisfile("CometV2/Modules/6872265039.lua") then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/LegoBedwarsHacker/CometV2/main/Modules/6872265039.lua"))()
    end
else
    if betterisfile("CometV2/Modules/Universal.lua") then
        loadstring(readfile("CometV2/Modules/Universal.lua"))()
    else
        loadstring(game:HttpGet("https://raw.githubusercontent.com/LegoBedwarsHacker/CometV2/main/Modules/Universal.lua"))()
    end
end
